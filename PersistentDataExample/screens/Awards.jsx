...
const Awards = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        // STEP 1
        // Uncomment this and update points
        // --------------------------------
        //awardsDB.updatePoints(1, 250);


        // STEP 2 Reload the page (Click back on Awards Page and then back into the "CLICK HERE")
        // STEP 3 Comment the line again
        // STEP 4 Restart the Program and the value will persist
            ...
            <ScrollView style={{marginTop: 10}}>
                {awards.map(award => (
                    <View
                        ...
                        style={[
                            styles.button,
                            { backgroundColor: award.points > 250 ? '#6bd0f6' : '#AAAAAA' }, //250 will be user.points eventually
                        ]}
                    >
